  ...
  return withMainFrame(
    ...
    >
      <Paper elevation={4} sx={{ width: '80%', height: '400px' }}>
          ...
          <div>
            ...
            <Grid item>
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell sx={{ fontWeight: 'bold' }} align="right">
                      <TableSortLabel
                        active={
                          orders.invitationOrderBy === 'invitation_type__name'
                        }
                        direction={orders.invitationOrder}
                        onClick={() =>
                          handleInvitationsSort(
                            orders.invitationOrder,
                            'invitation_type__name'
                          )
                        }
                      >
                        Tip tima:
                ...
                <TableBody>
                  {showInvites.onHold &&
                    invites.onHoldInvites &&
                    invites.onHoldInvites.map((row) => (
                      <TableRow
                        key={row.id}
                        sx={{
                      ...
                      >
                        ...
                        {row.details && (
                          <TableCell align="right">
                            {JSON.parse(row.details).team_name}
                          </TableCell>
                        )}
                        <TableCell align="right">
                          {new Date(row.time_sent).toDateString()}
                        </TableCell>
                        ...
                        <TableCell align="right">
                          <IconButton onClick={() => handleDeny(row.id)}>
                            <ClearIcon />
                          </IconButton>
                        </TableCell>
                      </TableRow>
                    ))}
                  {showInvites.accepted &&
                    invites.acceptedInvites &&
                    invites.acceptedInvites.map((row) => (
                      <TableRow
                        key={row.id}
                        sx={{
                          '&:last-child td, &:last-child th': { border: 0 },
                  ...
                  {showInvites.denied &&
                    invites.deniedInvites &&
                    invites.deniedInvites.map((row) => (
                      <TableRow
                        key={row.id}
                        sx={{
                          '&:last-child td, &:last-child th': { border: 0 },
        ...
        {showSection.showInvitationHistory && (
          <div>
            <Grid item>
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell sx={{ fontWeight: 'bold' }} align="right">
                      <TableSortLabel
                        active={
                          orders.historyOrderBy ===
                          'team_id__permanentteams__team_name'
                        }
                        direction={orders.historyOrder}
                        onClick={() =>
                          handleHistorySort(
                  ...
                  {gamesPlayed &&
                    gamesPlayed.map((row) => (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          {new Date(row.time_appointed).toDateString()}
                        </TableCell>
                      </TableRow>
                    ))}
                </TableBody>
                  ...
                  {friends &&
                    friends.map((friends) => (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <IconButton
                            onClick={() => handleFriendDelete(friends.id)}
                          >
                            <DeleteIcon />
                          </IconButton>
                        </TableCell>
